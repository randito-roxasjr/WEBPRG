<%-- 
    Document   : Home
    Created on : 03 19, 18, 9:58:56 PM
    Author     : Bryce Po
--%>
...
<body>
  ...
  <a id= "web-name" class="navbar-brand mb-0 h1" href="#"><img id = "web-icon" src="..\images\german-shepherd.svg" width="25" height="25" alt="">PupStudio</a>
  ...
  <div class="collapse navbar-collapse navbar-dark bg-dark" id="navbarSupportedContent">
	...
	<input type="search" placeholder="Search">
      ...
      <!-- SIGN UP -->
      <li class="nav-item active">
    	<a href="signup.jsp" class="nav-link"><i class="fas fa-user-plus"></i></i> Sign Up</a>
      </li>		
    </ul>
    ...
    <div class="dropdown show" align="right">
      <a id="login" class="nav-link dropdown-toggle active" href="#" role="button" id = "navbarDropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <form id="top-right-dd" class="dropdown-menu dropdown-menu-right pull-right p-4" action ="member.jsp" method="POST">
        ...
        <br/>
        <button type="submit" class="btn btn-primary btn-dark"><a href="member.jsp">Sign in</a></button>
      </form>
	</div>
...
<div class="sidenav">
  ...
  <div id="container" class="container">
    <div class="row">
        <div class="col-md-9">
            <div class="row">
                <div id="newsfeed" class="col-md-12 post">
                    <div class="row">
                        <div class="col-md-12">
                            <h4>
